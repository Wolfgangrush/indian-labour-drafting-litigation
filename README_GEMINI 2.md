# 🇮🇳 Indian Labour Law Drafting — Gemini CLI Port

> The same `indian-labour-drafting` pipeline you know, now invokable from Gemini CLI. **Same 6-agent pipeline. Same canonical agent specs. Same filing-grade output. Different LLM brain.**
...
├── skills/ (labour case-type templates + state exemplars)                   ← case-type templates (unchanged)
├── .gemini/                         ← NEW
│   └── commands/
...
```
<case-folder>/
├── state-config.md + case-config.md           ← advocate-supplied (required)
...
**Forum:** State Industrial Court / Labour Court / Conciliation Officer / Industrial Tribunal / Authority under the applicable state Shops & Establishments Act / Authority under Code on Wages 2019 / OSH Code 2020

**Case types covered:** Industrial dispute under ID Act 1947 (or IR Code 2020 once notified) · Shops & Establishments dispute · ESI claim · PF dispute · Gratuity claim · Bonus claim · Maternity Benefit · Code on Wages 2019 claim · OSH Code 2020 claim · Code on Social Security 2020 claim · Sexual Harassment (POSH Act 2013) Internal Committee complaint
